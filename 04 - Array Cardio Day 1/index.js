...
console.log(`Total years all the inventors lived all together: ${totalYears}`);

// 5. Sort the inventors by years lived
const oldest = inventors.sort((firstP, secondP) => {
  const lastGuy = firstP.passed - firstP.year;
  const nextGuy = secondP.passed - secondP.year;
